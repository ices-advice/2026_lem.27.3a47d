...
if (!pdf.plots) windows(width = 10, height = 7)
plot.index.corr(wk.object = list(x[[1]][as.character(2007:2025),2:5]), wk.type = "SURBAR") # Q1
if(!pdf.plots){ savePlot(filename = "report/SURBAR_corrQ1",type = "tiff")
  dev.off()}

if (!pdf.plots) windows(width = 10, height = 7)
plot.index.corr(wk.object = list(x[[2]][as.character(2006:2025),1:9]), wk.type = "SURBAR") # Q3
